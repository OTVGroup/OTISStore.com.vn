    ...
    <div class="products" id="product-list">
      ...
      <div class="product kvtm">
        ...
        <div class="product-name">
          <div class="product-pcs">Combo 2k:Mít ;Mít Sấy; Sinh Tố Mít</div>
        </div>
      </div>
      <!-- COMBO 2k -->
      <div class="product kvtm">
        <div class="product-img">
          ...
          <div class="product-img1">
            <img
              src="https://i.pinimg.com/736x/f3/15/ae/f315aeb25f643210a486c2cad55a27cc.jpg"
              alt="Nước Dứa"
            />
            <div class="product-no">x150</div>
          </div>
        ...
        <div class="product-name">
          <div class="product-pcs">Combo 2k:Dứa ;Dứa Sấy; Nước Dứa</div>
        </div>
      </div>
      <!-- COMBO 2k -->
      <div class="product kvtm">
        ...
        <div class="product-name">
          <div class="product-pcs">Combo 2k:Xoài ;Xoài Sấy; Sinh Tố Xoài</div>
        </div>
      </div>
      <!-- COMBO 2k -->
      <div class="product kvtm">
        ...
        <div class="product-name">
          <div class="product-pcs">Combo 2k:Nho ;Nho Sấy; Nước Nho</div>
        </div>
      </div>
      <!-- COMBO 1k -->
      <div class="product kvtm">
